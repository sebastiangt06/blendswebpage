...
import contactImg from "../assets/img/logoblends2.png";
...
export const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    let response = await fetch(
      "https://portfolio-api-0ce3.onrender.com/contact",
      {
        method: "POST",
        headers: {
            ...
            >
              <Row>
                <Col md={6} className='align-self-start'>
                  <img src={contactImg} alt="Contact Us" className='align-self-start'/>
                </Col>
                <Col md={6}>
